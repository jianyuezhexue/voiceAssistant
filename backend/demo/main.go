...
const (
	...
	TOKEN  = "08c4f4eea97b4b449e7155f82fd80215"
)
...
func testMultiInstance(num int) {
	...
	const PRE_URL_WSS = "wss://nls-gateway.cn-shanghai.aliyuncs.com/ws/v1"
	config := nls.NewConnectionConfigWithToken(PRE_URL_WSS, APPKEY, TOKEN)
